...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future<bool> myFuture() async {
      await Future.delayed(const Duration(seconds: 2)); //Aguarda 2 segundos para prosseguir com o resto do código
      var currentSeccond = DateTime.now().second; //Salva o segundo da hora atual
      debugPrint('currentSeccond = $currentSeccond'); //Printa o número no DEBUG CONSOLE
      return currentSeccond.isEven; //Retorna
    }
